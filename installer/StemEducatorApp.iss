...
Name: "{group}\Setup Wizard"; Filename: "{app}\setup.bat"; WorkingDir: "{app}"
Name: "{group}\{cm:UninstallProgram,{#MyAppName}}"; Filename: "{uninstallexe}"

[Run]
; Run the full setup wizard after files are copied — now visible and waits, so user sees result (fixes silent)
