(function(Scratch) {
  ...
  class ESP32Blocks {
    ...
    scanAndConnect() {
      ...
      try {
        window.top.dispatchEvent(new CustomEvent('hwShowPortPicker', {detail: {boardType: 'esp32'}}));
      } catch(e) {}
      return Promise.resolve();
    }
    ...
    wifiConnect(args) { sendCmd(null, 'wifiConnect', { ssid: args.SSID, password: args.PASS }); }
